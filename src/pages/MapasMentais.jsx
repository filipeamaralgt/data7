  ...
  return (
    <div className="container mx-auto p-4 md:p-6 lg:p-8">
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-8">
        <div>
           <div className="flex items-center gap-3"> {/* Added div to hold title and badge */}
          ...
          <p className="text-lg text-slate-500 dark:text-slate-400 mt-1">
            Visualize e organize suas estratégias de forma intuitiva.
          </p>
        </div>
        ...
        <Card className="w-full h-[60vh] dark:bg-slate-900/70 border-dashed border-2 border-slate-300 dark:border-slate-700">
          <CardContent className="h-full flex flex-col items-center justify-center text-center p-4">
            <div className="p-6 bg-slate-100 dark:bg-slate-800 rounded-full mb-4">
                <BrainCircuit className="h-12 w-12 text-slate-400 dark:text-slate-500" />
            </div>
            <h3 className="text-xl font-semibold text-slate-800 dark:text-slate-200">
              Crie seu primeiro mapa mental
            </h3>
            <p className="text-slate-500 dark:text-slate-400 max-w-md mt-2">
              Clique em "Novo Mapa Mental" para começar a conectar ideias, planejar campanhas e visualizar funis de uma forma completamente nova.
            </p>
          </CardContent>
        </Card>
      </motion.div>
